...
AddEventHandler("vehtuning",function(vehicle)
	...
	if IsEntityAVehicle(vehicle) then
		...
		SetVehicleNumberPlateText(vehicle,"CONEXAO")
...
RegisterNetEvent("azulfarol")
AddEventHandler("azulfarol",function(vehicle)
	local veh = GetVehiclePedIsUsing(PlayerPedId())
	ToggleVehicleMod(veh, 22, true) 
	SetVehicleHeadlightsColour(veh, 2)
end)

RegisterNetEvent("verdefarol")
AddEventHandler("verdefarol",function(vehicle)
	local veh = GetVehiclePedIsUsing(PlayerPedId())
	ToggleVehicleMod(veh, 22, true) 
...
RegisterNetEvent("amarelofarol")
AddEventHandler("amarelofarol",function(vehicle)
	local veh = GetVehiclePedIsUsing(PlayerPedId())
	ToggleVehicleMod(veh, 22, true) 
	SetVehicleHeadlightsColour(veh, 5)
end)

RegisterNetEvent("vermelhofarol")
AddEventHandler("vermelhofarol",function(vehicle)
	local veh = GetVehiclePedIsUsing(PlayerPedId())
	ToggleVehicleMod(veh, 22, true) 
...
RegisterNetEvent("rosafarol")
AddEventHandler("rosafarol",function(vehicle)
	local veh = GetVehiclePedIsUsing(PlayerPedId())
	ToggleVehicleMod(veh, 22, true) 
	SetVehicleHeadlightsColour(veh, 9)
end)

RegisterNetEvent("violetafarol")
AddEventHandler("violetafarol",function(vehicle)
	local veh = GetVehiclePedIsUsing(PlayerPedId())
	ToggleVehicleMod(veh, 22, true) 
